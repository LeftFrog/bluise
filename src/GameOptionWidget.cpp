...
GameOptionWidget::GameOptionWidget(const QString & label, const QString & text, QWidget * parent) : QWidget(parent), first_text(text)
{
...
GameOptionWidget::GameOptionWidget(const QString & label, const QString & text, bool _has_file_dialog, QWidget * parent) : QWidget(parent), has_file_dialog(_has_file_dialog), first_text(text) {
    QHBoxLayout* layout = new QHBoxLayout();
    lbl = new QLabel(label);
    ledit = new QLineEdit(text);
    layout->addWidget(lbl);
